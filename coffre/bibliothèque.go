...
func Ouvrirbibliotheque(objets []string, argent int) (bool, []string, int) {
	fmt.Println("\033[33mVous trouvez une bibliothèque :\033[0m")
	fmt.Println("Que voulez-vous faire ?")
	fmt.Println("1. Prendre ce qui est à l'intérieur")
